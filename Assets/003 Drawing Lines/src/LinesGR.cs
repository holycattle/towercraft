...
public class LinesGR : MonoBehaviour {
	...
	void Start() {
		...
		AddLine(ml, MakeQuad(new Vector3(0, 0, 0), new Vector3(0, 5, 0), 2f), false);
		AddLine(ml, MakeQuad(new Vector3(0, 0, 0), new Vector3(0, 0, 5), 2f), false);
	}
...
//		AddLine(ml, MakeQuad(new Vector3(0, 0, 0), new Vector3(0, 0, 5), 2f), false);
		if (Input.GetMouseButton(0)) {
			...
			if (s != Vector3.zero) {
				...
				AddLine(ml, MakeQuad(ls, e, 2f), false);
				Debug.Log("ls: " + ls.x + ", " + ls.y + ", " + ls.z);
